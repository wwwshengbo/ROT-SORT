...
def make_parser():
    ...
    # parser.add_argument("--txt_path", default="/home/www/code/MOT/BoT-SORT/BoT-SORT-main/YOLOX_outputs/yolox_x_mix_det/MOT17_track_results/", help="path to tracking result path in MOTChallenge format")
    # parser.add_argument("--save_path", default="/home/www/code/MOT/BoT-SORT/BoT-SORT-main/YOLOX_outputs/yolox_x_mix_det/interpolation_MOT17_track_result/", help="save result path, none for override")

    # parser.add_argument("--txt_path",
    #                     default="/home/www/code/MOT/BoT-SORT/BoT-SORT-main/YOLOX_outputs/yolox_x_mix_mot20_ch/MOT20_track_results/",
    #                     help="path to tracking result path in MOTChallenge format")
    # parser.add_argument("--save_path",
    #                     default="/home/www/code/MOT/BoT-SORT/BoT-SORT-main/YOLOX_outputs/yolox_x_mix_mot20_ch/interpolation_MOT20_track_result/",
    #                     help="save result path, none for override")

    parser.add_argument("--txt_path",
                        default="/home/www/code/MOT/BoT-SORT/BoT-SORT-main/YOLOX_outputs/yolox_x_mix_mot20_ch/track_results_MOT20_train_half",
                        help="path to tracking result path in MOTChallenge format")
    parser.add_argument("--save_path",
                        default="/home/www/code/MOT/BoT-SORT/BoT-SORT-main/YOLOX_outputs/yolox_x_mix_mot20_ch/interpolation_track_results_MOT20_train_half",
                        help="save result path, none for override")
